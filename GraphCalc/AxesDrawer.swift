...
class AxesDrawer
{
    ...
    // colors used to draw axis
    var text_color = UIColor()
    var tick_color = UIColor()
    var axis_color = UIColor()
    var grid_color = UIColor()
    ...
    // set all four colors from a given base color
    var color : UIColor {
        set {
            text_color = newValue
            tick_color = newValue
            axis_color = newValue
            grid_color = newValue.colorWithAlphaComponent(0.25)
        }
        get {
            return text_color
        }
    ...
    init() {
        color = UIColor.blueColor() // use a default base color of blue
    }
    ...
    private func drawHashmarkAtLocation(bounds: CGRect, _ location: CGPoint, _ text: AnchoredText)
    {
